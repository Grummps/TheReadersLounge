...
function Navbar({ history }) {
  ...
  return (
    <nav className="relative bg-neutral-900 h-1/5 text-white top-0 left-0 right-0 z-50 border-b border-white border-opacity-30 shadow-xl">
      ...
      <div
        className="absolute top-full left-1/2 transform -translate-x-1/2 bg-gray-400 opacity-70 z-0"
        style={{
          width: '20vw',
          height: '2.25rem',
      ...
      {/* The Trapezoid Shape */}
      <div
        className="absolute top-full left-1/2 transform -translate-x-1/2 bg-neutral-900 z-0"
        style={{
          width: '18vw',
          height: '2rem',
          clipPath: 'polygon(0% 0%, 100% 0%, 80% 100%, 20% 100%)',
